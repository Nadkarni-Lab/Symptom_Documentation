...
# Load symptom data and race data
...
# Filter symptom data by rater type and select relevant columns
# Patient
...
# Calculate the percentage of patients reporting each symptom by nurse and race
perc_tot_n <- c()
race0_perc_tot_n <- c()
race1_perc_tot_n <- c()
race2_perc_tot_n <- c()
...
# Calculate the percentage of patients reporting each symptom by patient and race
perc_tot_p <- c()
race0_perc_tot_p <- c()
race1_perc_tot_p <- c()
race2_perc_tot_p <- c()
...
# Calculate the percentage of patients reporting each symptom by physician and race
perc_tot_d <- c()
race0_perc_tot_d <- c()
race1_perc_tot_d <- c()
race2_perc_tot_d <- c()
